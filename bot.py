...
LANGS = {
    "uz": {
        ...
        "answers_saved_user": "✅ Javob saqlandi. O‘zgartirmoqchi bo‘lsangiz qayta yuboring. Tugatmoqchi bo'lsangiz Finish tugmasini bosing☝️",
    ...
    "ru": {
        ...
        "answers_saved_user": "✅ Ответ сохранён. Если хотите изменить, отправьте заново. Чтобы завершить тест, нажмите кнопку завершить.☝️",
    ...
    "en": {
        ...
        "answers_saved_user": "✅ Answer saved. If you want to change it, send it again. To finish the test, press the Finish button.☝️",
